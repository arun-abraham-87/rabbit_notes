...
import { UserIcon, ViewColumnsIcon, Squares2X2Icon } from '@heroicons/react/24/solid';
import { parseNoteContent } from '../utils/TextUtils';
import WorkstreamPeopleView from './WorkstreamPeopleView';

const PeopleList = ({ notes, searchQuery }) => {
  const [viewMode, setViewMode] = useState('grid'); // 'grid' or 'workstream'
  ...
  return (
    <div className="space-y-4">
      ...
      {viewMode === 'workstream' ? (
        <WorkstreamPeopleView notes={notes} searchQuery={searchQuery} />
      ) : (
